                ...
                SELECT
                    ...
                    CASE
                        ...
                        LEAD(prd_start_dt) over (
                            ...
                            ORDER BY
                                prd_start_dt
                        ) :: DATE - INTERVAL '1 day' AS prd_end_dt
                        FROM
                            bronze.crm_prd_info;
end_time:= clock_timestamp();
RAISE notice '>> Load Duration: % seconds',
...
RAISE notice '>> Loading: silver.crm_sales_details';
                        ...
                        SELECT
                            ...
                            sls_prd_key,
                            sls_cust_id,
                            -- Replace previous date conversion lines in crm_sales_details section with:
                            CASE
                                WHEN sls_order_dt IS NULL
                                OR sls_order_dt < 10000000 THEN NULL
                                ELSE TO_DATE(
                                    sls_order_dt :: text,
                                    'YYYYMMDD'
                                )
                            ...
                            CASE
                                ...
                                OR sls_ship_dt < 10000000 THEN NULL
                                ELSE TO_DATE(
                                    sls_ship_dt :: text,
                                    'YYYYMMDD'
                                )
                            ...
                            CASE
                                ...
                                OR sls_due_dt < 10000000 THEN NULL
                                ELSE TO_DATE(
                                    sls_due_dt :: text,
                                    'YYYYMMDD'
                                )
                            ...
                            CASE
                                ...
                                OR sls_price <= 0 THEN sls_sales / NULLIF(
                                    sls_quantity,
                                    0
                                )
                                ELSE sls_price
