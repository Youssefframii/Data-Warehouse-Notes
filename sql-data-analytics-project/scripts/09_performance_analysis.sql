...
Purpose:
    ...
    - Benchmark performance and identify high-performing entities.
...
-- Analyze yearly performance of products: compare sales to average and previous year
...
SELECT
    ...
    -- Compare to average sales of the product
